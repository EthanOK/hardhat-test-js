    ...
    ERC721Enumerable
{
    ...
    // id => fees HasSecondarySaleFees 二次销售费用
    ...
    // The interface identifier 0x150b7a02 is for the ERC721TokenReceiver interface
    ...
    ) HasContractURI(contractURI) HasTokenURI(_tokenURIPrefix) {
        name = _name;
        symbol = _symbol;
